...
public class StudyCafeFileHandler {
    ...
    public static final String STUDY_CAFE_PASS_LIST_CSV = "src/main/resources/cleancode/studycafe/pass-list.csv";
    public static final String STUDY_CAFE_LOCKER_CSV = "src/main/resources/cleancode/studycafe/locker.csv";
